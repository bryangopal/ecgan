...
class ResNet(nn.Module):
  def __init__(self, block: Type[Union[BasicBlock, Bottleneck]], layers: List[int],
    ...
    self.conv1 = nn.Conv1d(num_input_channels, self.in_channels, kernel_size=7, stride=2, padding=3,
                           bias=False)
...
def resnet18(num_input_channels: int, **kwargs: Any) -> ResNet:
  return ResNet(BasicBlock, [2, 2, 2, 2], num_input_channels, **kwargs)

def resnet34(num_input_channels: int, **kwargs: Any) -> ResNet:
  return ResNet(BasicBlock, [3, 4, 6, 3], num_input_channels, **kwargs)

def resnet18_bn(num_input_channels: int, **kwargs: Any) -> ResNet:
  return ResNet(Bottleneck, [2, 2, 2, 2], num_input_channels, **kwargs)

def resnet50(num_input_channels: int, **kwargs: Any) -> ResNet:
  return ResNet(Bottleneck, [3, 4, 6, 3], num_input_channels, **kwargs)

def resnet101(num_input_channels: int, **kwargs: Any) -> ResNet:
  return ResNet(Bottleneck, [3, 4, 23, 3], num_input_channels, **kwargs)

def resnet152(num_input_channels: int, **kwargs: Any) -> ResNet:
  return ResNet(Bottleneck, [3, 8, 36, 3], num_input_channels, **kwargs)

def resnext50_32x4d(num_input_channels: int, **kwargs: Any) -> ResNet:
  kwargs['groups'] = 32
  kwargs['width_per_group'] = 4
  return ResNet(Bottleneck, [3, 4, 6, 3], num_input_channels, **kwargs)

def resnext101_32x8d(num_input_channels: int, **kwargs: Any) -> ResNet:
  kwargs['groups'] = 32
  kwargs['width_per_group'] = 8
  return ResNet(Bottleneck, [3, 4, 23, 3], num_input_channels, **kwargs)

def wide_resnet50_2(num_input_channels: int, **kwargs: Any) -> ResNet:
  kwargs['width_per_group'] = 64 * 2
  return ResNet(Bottleneck, [3, 4, 6, 3], num_input_channels, **kwargs)

def wide_resnet101_2(num_input_channels: int, **kwargs: Any) -> ResNet:
  kwargs['width_per_group'] = 64 * 2
  return ResNet(Bottleneck, [3, 4, 23, 3], num_input_channels, **kwargs)